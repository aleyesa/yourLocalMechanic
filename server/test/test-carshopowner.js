...
import { TEST_DATABASE } from '../dev/config/config';

chai.use(chaiHttp);

const appConnection = chai.request(app).keepOpen();
...
describe('Your Local Car Shop', () => {
  ...
  describe('Car shop owner crud application:', () => {

    it('Get all car shop owner request', () => {

      appConnection.get('/api/carshopowner')
