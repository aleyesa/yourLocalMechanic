...
const getAllPhoneNumbers = (req, res) => {
  ...
  .catch(err => res.json('no phone numbers found.'));
};
...
const getPhoneNumber = (req, res) => {
  ...
  .then(phoneNumber => res.json(phoneNumber))
  .catch(err => res.json('could not find phone number.'));
};
...
const addPhoneNumber = (req, res) => {
  ...
  .create(req.body)
  .then(phoneNumber => res.json(phoneNumber))
  .catch(err => res.json('failed to add phone number.'));
};
...
const updatePhoneNumber = (req, res) => {
  ...
  .then(phoneNumber => res.json(phoneNumber))
  .catch(err => res.json('failed to update phoneNumber.'));
};
